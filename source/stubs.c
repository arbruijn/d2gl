...
fix joy_get_button_down_time(int button) { return 0; }
int joy_get_button_down_cnt(int button) { return 0; }
...
void com_abort(void) {}
void com_send_data(ubyte *buf, int len, int repeat) {}
int com_level_sync(void) { return 0; }
